...
QWidgetDraw1::QWidgetDraw1(QWidget *parent) : QWidget(parent)
{
...
void QWidgetDraw1::setLabelText(QString labelText)
{
    this->label->setText(labelText);
}

void QWidgetDraw1::refresh( int data )
{
...
void QWidgetDraw1::paintEvent(QPaintEvent *event)
{
    QPainter *painter=new QPainter();
    painter->begin(this);
    //this->draw(painter);
...
void QWidgetDraw1::draw(QPainter *painter,int data)
{
...
void QWidgetDraw1::drawWaveFromArray(QPainter *painter,int data)
{
    int datapoint = 0;
    int height=this->map->height();

    datapoint=-30+height-2*height*data/256;
...
void QWidgetDraw1::drawWave(QPainter *painter,int data)
{
